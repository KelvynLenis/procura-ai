  ...
  return (
    <>
      <div className="h-[86px] shadow-lg bg-white flex justify-center items-center lg:hidden px-2">
        ...
        >
          <Smartphone size={24} className={cn(pathname === 'meus-dispositivos' && 'text-secondary')} />
          <div className="flex flex-col items-center justify-center">
            <span className={cn('w-20', pathname === 'meus-dispositivos' && 'text-secondary')}>Meus dispositivos</span>
            {
        ...
        >
          {
            pathname === 'cadastrar-dispositivo' ? (
              <Image src={AddDeviceFocused} alt="Devices icon" className="w-6 h-6" />
          ...
          <div className="flex flex-col items-center justify-center">
            <span className={cn('w-16', pathname === 'cadastrar-dispositivo' && 'text-secondary')}>Adicionar novo</span>
            {
              pathname === 'cadastrar-dispositivo' && (
                <span className="w-1/2 h-0.5 bg-secondary rounded-xl" />
              )
        ...
        >
          {
            pathname === 'contatos-de-confianca' ? (
              <Image src={ContactsFocusedIcon} alt="Devices icon" className="w-6 h-6" />
          ...
          <div className="flex flex-col items-center justify-center">
            <span className={cn('w-[70px]', pathname === 'contatos-de-confianca' && 'text-secondary')}>Contatos de confiança</span>
            {
              pathname === 'contatos-de-confianca' && (
                <span className="w-1/2 h-0.5 bg-secondary rounded-xl" />
              )
        ...
        >
          ...
          <div className="h-8">
            <span className={cn('w-16', pathname === 'perfil' && 'text-secondary')}>Perfil</span>
          </div>
        </button>
      </div>
    </>
