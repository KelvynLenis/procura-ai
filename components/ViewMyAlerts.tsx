                  ...
                  <div className="flex bg-zinc-100 p-4">
                    ...
                    <div className="flex flex-col gap-2">
                      <span className="text-sm font-medium">
                        Deseja criar um boletim de ocorrência na delegacia
                        online da Polícia Civil?
                      </span>
                      <p className="text-justify text-sm">
                        Em casos de perda, ou furto simples é possível criar um
                        boletim de ocorrência online, feito diretamente pelo
                        site da delegacia online da polícia civil da Paraíba. O
                        boletim criado será analisado pela Polícia Civil e a
                        certidão será enviada para o e-mail informado. Em caso
                        de roubos, onde houve ameaça à vida, é necessário se
                        dirigir à uma delegacia presencialmente.
                      </p>
                      <Link
                        href={
