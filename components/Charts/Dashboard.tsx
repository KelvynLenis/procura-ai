...
export function Dashboard() {
  ...
  useEffect(() => {
    ...
    if (
      ...
      console.log(
        "Dashboard: Ocorrência selecionada não encontrada, limpando seleção",
      );
      clearSelection();
    }
  ...
  return (
    <>
      ...
      <div className="flex h-full w-full flex-col items-center justify-start gap-5 py-5">
        <div className="relative flex w-[100%] flex-col justify-center gap-4 self-start rounded-xl bg-white p-4 ring-1 ring-zinc-300 md:mr-2 2xl:w-[100%]">
          <div className="flex justify-between">
            ...
            <button
              ...
              className="flex items-center gap-1 text-sm text-procura-ai-blue hover:opacity-50"
            >
              Expandir
              <BiExpandAlt size={18} />
            </button>
        ...
        <div className="flex w-full justify-around">
          <div className="grid w-1/2 grid-cols-2 gap-1 self-start">
            <CardChart
              variant="blue"
          ...
          <div className="flex h-[380px] w-1/2 flex-col items-center justify-center gap-2 self-start rounded-lg bg-white text-sm ring-1 ring-zinc-300">
            <span className="flex w-full flex-col items-start px-4 pt-3 font-semibold text-procura-ai-blue">
        ...
        <div className="flex h-fit w-full flex-col items-center justify-center gap-2 self-start rounded-lg bg-white p-3 text-sm ring-1 ring-zinc-300">
          <div className="flex w-full justify-between">
            <span className="flex w-full flex-col items-start self-start font-semibold text-procura-ai-blue">
          ...
          <div className="relative flex h-full w-full items-center justify-center rounded-sm bg-zinc-200">
