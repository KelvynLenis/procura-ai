              ...
              render={({ field }) => (
                <FormItem className="flex flex-col w-full">
                  <FormLabel className="w-full text-center items-center flex flex-col">
                    ...
                    {isHintOpen && (
                      <div className="flex w-full flex-col md:absolute md:flex z-[100] md:right-[8rem] -right-[21rem] md:top-[5rem] md:bg-[#D8A912] lg:z-[100] lg:left-1/3 lg:w-80 lg:top-20 3xl:left-[20%] gap-2 bg-[#D8A912]/30 lg:bg-[#D8A912]/100 font-normal p-2 rounded-md text-justify leading-5">
