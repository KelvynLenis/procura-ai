...
export function EditProfileForm() {
  ...
  const handleRemoveImage = () => {
    ...
    const fileMobileInput = document.getElementById(
      "fileMobile",
    ) as HTMLInputElement;
    if (fileInput) {
      fileInput.value = "";
    ...
    try {
      ...
      const callFunction = async () => {
        ...
        if (
          ...
          (imageState.isDeleted || imageState.tempFile)
        ) {
          try {
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-3">
                        ...
                        <p className="text-xs text-zinc-600">
                          * São suportadas imagens nos formatos .png .jpg de até
                          10 mb
                        </p>
                      </div>
