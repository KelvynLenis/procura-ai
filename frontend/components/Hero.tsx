...
export function Hero() {
  return (
    <section className="w-full flex items-center justify-end md:h-[400px] lg:h-[630px] xl:h-[800px] h-full text-lg md:text-xl lg:text-4xl text-white bg-landing-bg bg-cover bg-center px-2 md:px-5 lg:px-10 py-7">
