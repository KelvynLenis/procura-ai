...
export async function updateDistrictCounters(
  ...
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_API_URL}/databases/${process.env.NEXT_PUBLIC_DATABASE_ID}/collections/${process.env.NEXT_PUBLIC_COLLECTION_DISTRICT}/documents/${district.$id}`,
    {
      method: "PATCH",
      headers: {
